...
void InitialiseUAREA()
{
    ...
    cout<<"Project CVFS : UAREA initialised succesfully\n";
}
...
void InitialiseSuperblock()
{
    ...
    cout<<"Project CVFS : Superblock initialised succesfully\n";
}
...
void CreateDILB()
{
    ...
    cout<<"Project CVFS : DILB created succesfully\n";
}
...
void StartAuxilaryDataInitialisation()
{
    ...
    cout<<"Project CVFS : Auxilary data initalised succesfully\n";
}
...
{
    printf("---------------------------------------------------------\n");
    printf("----------- Command Manual of Project CVFS -----------\n");
    printf("---------------------------------------------------------\n");

    printf("exit : It is used to terminate the shell of Project CVFS\n");
    printf("clear : It is used to clear the console of Project CVFS\n");
    printf("creat : it is used of create new regular file\n");
    printf("Unlink : it is used to  delete exsiting file\n");
    printf("stat : It is used to display statistical information about file\n");
    printf("ls : It is used to list out all files ");
    printf("write : It is used to write the data into files ");
    printf("read : It is used to read the data from files ");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to terminate the Project CVFS\n");

        printf("Usage : exit\n");     
    }
    else if(strcmp(name,"Unlink") == 0)
    {
        printf("Description : This command is used to create delete file on our file system\n");
    ...
    {
        printf("Description : This command is used to display of statistical information of  file on our file system\n");

        printf("Usage : stat File_name\n");
        printf("File_name : The name of file whose information uou want to display\n");

    }
    else if(strcmp(name,"ls") == 0)
    {
        printf("Description : This command is used to list the\n");
    ...
    {
        printf("Description : This command is used to creat the data intp the file\n");
    ...
    else if(strcmp(name,"read") == 0)
    {
        ...
        printf("File_Descriptot : Its a value returned bye create system call\n");
    ...
    for(i =0 ; i < MAXINODE ; i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i]->ptrinode->FileName,name) == 0 )
            {
                ...
                // Dellocate memory of file table 

                free(uareaobj.UFDT[i]);
                //Set NULL to UFDT member
                uareaobj.UFDT[i] = NULL;

                //Increamnet the value of freeInode Count
                superobj.FreeInodes++;
...
//  Description :       It is used to Display the Information about the all file in the Directory
//  Input :             Nothing
//  Output :            Nothing
//  Author :            Samyak Kailas Medhe
//  Date :              15/08/2025
...
//  Output :            Number of bytes succefully written into the file
//  Author :            Samyak Kailas Medhe
//  Date :              15/08/2025
//
///////////////////////////////////////////////////////////////////////
...
int write_file(
                    ...
                    char *data,     // Data that you want to write
                ...
                )
{
    ...
    printf("Data that you want to write : %s\n",data);
    ...
    // if there is no permission to write the data intp the file
...
//  Output :            Number of bytes succefully read from the file
//  Author :            Samyak Kailas Medhe
//  Date :              15/08/2025
//
///////////////////////////////////////////////////////////////////////
...
int read_file(
                ...
                int size  // Number of Bytes that you want to read
            )
{
    // Invalid value of fd 
    if( fd < 0 || fd > MAXOPENEDFILES)
...
int main()
{
    ...
    cout<<"----------------------------------------------------------\n";
    cout<<"--------- Project CVFS Started Succesfully ------------\n";
    cout<<"----------------------------------------------------------\n";
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using Project CVFS\n");
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp(Command[0],"Unlink") == 0)
            {
                ...
                {
                    printf("Error : Unable to do Unlink Activity as file os Not present\n");
                }   
            ...
            else if(strcmp(Command[0],"stat") == 0)
            {
                ...
                {
                    printf("Error : Unable to do Display Statistic Activity as file os Not present\n");
                }   
                else if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : Invalid parameters for the function\n");
            ...
            else if(strcmp(Command[0],"write") == 0)
            {
                ...
                {
                    printf("ERROR : Insufficient space in the data blovk for th file\n");
                ...
                {
                    printf("%d butes gets succesfully written into the file\n",iRet);
