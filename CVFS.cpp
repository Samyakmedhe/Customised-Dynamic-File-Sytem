...
void man(char *name)
{
    ...
    {
        printf("Description : Used to wirte into regular file\n");
        printf("Usage : wirte File_name\n After this enter the data that w want to wirte\n");
    }
    ...
    {
        printf("Description : Used to close the open file\n");
        printf("Usage : close File_name \n");
    }
    else if(strcmp(name,"closeall") == 0)
    {
        printf("Description : Used to close all the open file\n");
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information of files using file description\n");
...
PINODE Get_Inode(const char * name)
{
    PINODE temp = head;
    int i = 0;
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(fd == -1)
                {
                    printf("ERRROR : Incorrect parameter\n");
                    continue;
                }
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret >= 0)
                printf("File is succesffully created with file descriptor : %d\n",ret);
                if(ret == -1)
                printf("ERROR : Incorrect parameter\n");
                if(ret == -2)
                printf("ERROR : there is no inodes\n");
                if(ret == -3)
                printf("ERROR : file is allready exist\n");
                if(ret == -4)
                printf("ERROR : memory alloction failure\n");
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                printf("File is succesffully Open with file descriptor : %d\n",ret);
                if(ret == -1)
                printf("ERROR : Incorrect parameter\n");
                if(ret == -2)
